    ...
    value: function drawAnimation(timeStamp) {
      ...
      try {
        for (var _iterator2 = this.playerList[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          ...
          var prevHide = player.prevPracticalHide;
          var curHide = player.practicalHide;
          player.prevPracticalHide = curHide;

          if (EmotePlayer.suspendWhenHide) {
            if (curHide) {
              if (!prevHide) {
                console.log("skip");
                player.skip();
          ...
          if (player.canvas == null || player.practicalHide) continue;
...
var EmotePlayer = function () {
  ...
  _createClass(EmotePlayer, [{
    ...
    value: function initMembers() {
      ...
      this.prevPracticalHide = true;
      this.charaHeight = 0;
      this.charaProfile = {};
      this.charaBounds = {};
      this._meshDivisionRatio = 1;
      this._transformOrderMask = 0x201;
      this._hairScale = 1;
      this._partsScale = 1;
      this._bustScale = 1;
      this._speed = 1;
    ...
    value: function loadData() {
      ...
      EmotePlayer_SetTransformOrderMask(this.playerId, this._transformOrderMask);
      ...
      EmotePlayer_AddUserDefinedVariable(this.playerId, "_globalR");
      EmotePlayer_AddUserDefinedVariable(this.playerId, "_globalG");
      EmotePlayer_AddUserDefinedVariable(this.playerId, "_globalB");
      EmotePlayer_AddUserDefinedVariable(this.playerId, "_globalA");
      ...
      try {
        for (var _iterator3 = this._diffTimelineSlot[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
          ...
          if (_val != "") EmotePlayer_PlayTimeline(this.playerId, _val, EmotePlayer.TimelinePlayFlags.PARALLEL | EmotePlayer.TimelinePlayFlags.DIFFERENCE);
        }
      } catch (err) {
    ...
    key: "startRecordAPILog",
    value: function startRecordAPILog() {
      if (!this.initialized) return;
      EmotePlayer_StartRecordAPILog(this.playerId);
    }
  }, {
    key: "stopRecordAPILog",
    value: function stopRecordAPILog() {
      if (!this.initialized) return;
      EmotePlayer_StopRecordAPILog(this.playerId);
    }
  }, {
    key: "startReplayAPILog",
    value: function startReplayAPILog() {
      if (!this.initialized) return;
      EmotePlayer_StartReplayAPILog(this.playerId);
    }
  }, {
    key: "stopReplayAPILog",
    value: function stopReplayAPILog() {
      if (!this.initialized) return;
      EmotePlayer_StopReplayAPILog(this.playerId);
    }
  }, {
    key: "clearAPILog",
    value: function clearAPILog() {
      if (!this.initialized) return;
      EmotePlayer_ClearAPILog(this.playerId);
    }
  }, {
    key: "onRegister",
    ...
    key: "practicalHide",
    get: function get() {
      if (!this.initialized) return this._hide;else return this._hide || this._globalA == 0 && EmotePlayer_GetVariable(this.playerId, "_globalA") == 0;
    }
  }, {
    key: "hide",
    get: function get() {
    ...
    key: "transformOrderMask",
    get: function get() {
      return this._transformOrderMask;
    },
    set: function set(val) {
      this._transformOrderMask = val;
      if (this.initialized) {
        this.modified = true;
        EmotePlayer_SetTransformOrderMask(val);
      }
    }
  }, {
    key: "speed",
    ...
    get: function get() {
      if (!this.initialized) return false;
      return EmotePlayer_IsRecordingAPILog(this.playerId);
    }
  }, {
    key: "replayingAPILog",
    get: function get() {
      if (!this.initialized) return false;
      return EmotePlayer_IsReplayingAPILog(this.playerId);
    }
  }, {
    key: "apiLog",
    set: function set(val) {
      if (!this.initialized) return;
      EmotePlayer_SetAPILog(this.playerId, val);
    },
    get: function get() {
      if (!this.initialized) return "";
      return EmotePlayer_GetAPILog(this.playerId);
    }
  }]);
...
EmotePlayer.suspendWhenHide = true;
